...
def create_test_db(path):
    ...
    conn.execute("INSERT INTO partner_transactions (id, partner_name, kind, type, amount, date, notes, currency, payment_type, time, source_type, source_id, source_role, affects_qasa, affects_partner_cash, affects_profit, related_source_type, related_source_id) VALUES (101, 'أمير', 'شريك', 'ايداع دفعة زبون', 2500000, '2026-03-15', 'دفعة زبون #بيع_سيارة_CAR003', 'IQD', 'قاصه', '11:00', 'customer_payment', '100', 'cash_movement', 1, 1, 0, 'car', 'CAR003')")
    conn.execute("INSERT INTO partner_transactions (id, partner_name, kind, type, amount, date, notes, currency, payment_type, time, source_type, source_id, source_role, affects_qasa, affects_partner_cash, affects_profit, related_source_type, related_source_id) VALUES (102, 'منتصر', 'شريك', 'ايداع دفعة زبون', 2500000, '2026-03-15', 'دفعة زبون #بيع_سيارة_CAR003', 'IQD', 'قاصه', '11:00', 'customer_payment', '100', 'cash_movement', 1, 1, 0, 'car', 'CAR003')")
    ...
    conn.execute("INSERT INTO financial_ledger (date, time, account_type, account_id, debit, credit, currency, reference_type, reference_id, type_, description, notes) VALUES ('2026-03-15', '11:00', 'cash', 'قاصه', 5000000, 0, 'IQD', 'partner_transaction', '101', 'ايداع دفعة زبون', 'إيداع دفعة زبون', NULL)")
