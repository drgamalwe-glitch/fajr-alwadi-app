...
function carToForm(car: Car): CarFormState {
  return {
    ...
    purchaseType: (car.purchase_type as any) ?? "كاش",
...
export function CarsTab({
  ...
  return (
    <div className="cars-page" style={{ position: "relative", display: "flex", flexDirection: "column", gap: "1.25rem", flex: 1, minHeight: 0, overflow: "hidden" }}>
