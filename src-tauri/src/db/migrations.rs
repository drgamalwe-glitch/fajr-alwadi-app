//! Schema migrations v1 through v35 (the init_db body). The actual
migration code lives in crate::legacy::init_db; this module exists as the
canonical home for future migration work.
//!
